								...
								while ($row = $complainant->fetch_assoc()):
									...
									<tr>
										...
										<td class="">
											...
											<p>Address: </b></p>
											<p><small><i><b>
															<?php echo $row['address'] ?></i></small></p>
										</td>
										<td class='text-center'>
										...
										<td class="text-center">
											<?php if ($row['status'] == 1): ?>
												<button class="btn btn-sm btn-outline-primary unverify_user" type="button"
													data-id="<?php echo $row['id'] ?>">Unverify</button>
											<?php else: ?>
												<button class="btn btn-sm btn-outline-primary verify_user" type="button"
													data-id="<?php echo $row['id'] ?>">Verify</button>
											<?php endif; ?>
											<button class="btn btn-sm btn-outline-primary view_complaints" type="button"
												data-id="<?php echo $row['id'] ?>"
												data-name="<?php echo $row['name'] ?>">View Complaints</button>
										</td>
									</tr>
								<?php endwhile; ?>
							</tbody>

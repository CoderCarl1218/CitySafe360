	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
		<div class="container">
			<a class="navbar-brand" href="#">
				<img src="img/logo4.jpg" alt="CitySafe360 Logo" class="img-fluid">
				<span class="text-warning">CitySafe</span>360</a> <button aria-controls="navbarSupportedContent"
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
				...
				<div class="carousel-caption">
					<h5>CitySafe360</h5>
					<p>A Roxas City Incident and Emergency Response Reporting Platform</p>
					<p><a class="btn btn-warning mt-3" id="form-open" href="#">Report an Incident</a></p>
				</div>
			</div>
